...
Each shadow map in that implementation was also being processed by a Light-Space Perspective Shadow Map (LiSPSM)\cite{wimmer2004light} technique, which performs poorly in the dueling frusta case and also exhibited some mysterious bugs. 
