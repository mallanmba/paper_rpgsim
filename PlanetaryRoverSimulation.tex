...
Then we applied a 9-sample Poisson filter which further smoothed the shadows and does a much better job of preserving small features than the uniform filter.
