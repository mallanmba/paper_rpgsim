...
Driving planetary rovers on the Lunar poles is not a common use case, however. Consequently, significant modifications, extensions, and adaptations were needed in order to implement our target scenarios.  
